...
![](https://github.com/pendd/picture/raw/master/Vue/lifecycle.png)
...
> vue 在<style lang='scss' scope> 启动的时候会报错

npm install sass-loader node-sass --save-dev

> 结果还是报错：TypeError [ERR_INVALID_ARG_TYPE]: The "path" argument must be of type string
